...
def initialOctConvLayer(ip, filters, kernel_size=(3, 3), strides=(1, 1),
...
def finalOctConvLayer(ip_high, ip_low, filters, kernel_size=(3, 3), strides=(1, 1),
...
def octConvBlock(ip_high, ip_low, filters, kernel_size=(3, 3), strides=(1, 1),
                 alpha=0.5, padding='same', dilation=None, bias=False):
    """
...
if __name__ == '__main__':
    ...
    xh, xl = initialOctConvLayer(ip, filters=64, kernel_size=(9, 9))

    xh, xl = octConvBlock(xh, xl, filters=32, kernel_size=(1, 1))
